...
const guestInput = document.querySelector('input[name="guestQuantity"]');
...
const inputs = [eventInput, cityInput, guestInput, nameInput, numberInput, emailInput, dateInput, budgetInput];
...
const validateInput = () => {
    ...
    if (isNaN(guestInput.value) || !guestInput.value) {
        isFormValid = false;
        invalidateElement(guestInput);
    }

    if (!budgetInput.value) {
        isFormValid = false;
        invalidateElement(budgetInput);
    }
